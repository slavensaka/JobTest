...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2015 at 05:11 PM
...
CREATE TABLE IF NOT EXISTS `telefon` (
  ...
  `zaposlenik_id` int(10) unsigned NOT NULL,
  `telefon` varchar(45) COLLATE utf8_croatian_ci DEFAULT NULL,
  PRIMARY KEY (`id`,`zaposlenik_id`),
  KEY `telefon_FKIndex1` (`zaposlenik_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_croatian_ci AUTO_INCREMENT=74 ;

--
-- Dumping data for table `telefon`
--

INSERT INTO `telefon` (`id`, `zaposlenik_id`, `telefon`) VALUES
(1, 1, '031202333'),
(2, 1, '03146856'),
(3, 1, '031457346'),
(4, 2, '031345678'),
...
CREATE TABLE IF NOT EXISTS `zaposlenik` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_croatian_ci AUTO_INCREMENT=50 ;
